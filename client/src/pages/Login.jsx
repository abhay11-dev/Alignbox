      ...
      <div className="login-wrapper">
        <div className="login-left">
          <div className="brand-section">
            ...
            <h1>Welcome Back!</h1>
            <p>Sign in to continue to your account and start chatting with your groups.</p>
          </div>
          ...
          <div className="features-list">
            <div className="feature">
              ...
              <div>
                ...
                <p>Instant communication with your team</p>
              </div>
            </div>
            <div className="feature">
              <div className="feature-icon">🔒</div>
            ...
            <div className="feature">
              ...
              <div>
                ...
                <p>Connect with multiple teams easily</p>
              </div>
            </div>
          </div>
        ...
        <div className="login-right">
          ...
          <div className="mobile-brand">
            ...
            <p className="mobile-tagline">Sign in to your account</p>
          </div>
          ...
          <form className="login-form" onSubmit={submit}>
            ...
            <div className="form-footer">
              ...
              <Link className="signup-link" to="/register">Sign up for free</Link>
            </div>
          </form>
        </div>
      </div>
